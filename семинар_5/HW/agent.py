...
# блок 9.5 — лог шагов в JSONL
def write_trace(run_id: str, trace: list, logs_dir: str = "logs"):
    """Записывает лог шагов в JSONL"""
    from datetime import datetime
    Path(logs_dir).mkdir(parents=True, exist_ok=True)
    log_file = Path(logs_dir) / "trace.jsonl"
