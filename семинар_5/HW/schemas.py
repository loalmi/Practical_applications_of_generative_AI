...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Сравнить значение метрики в двух периодах. Возвращает значения, "
                "дельту (изменение) и отношение (во сколько раз). "
                "Использовать для вопросов типа 'во сколько раз вырос', "
                "'на сколько изменился', 'сравни значение в двух датах'."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "metric": {
                        ...
                        "description": "Название метрики: key_rate, fx_USD, fx_EUR, fx_CNY, cpi, unemployment"
                    },
                    "period_a": {
                        "type": "string",
                        "description": "Первый период: YYYY-MM (для месячных данных) или YYYY-MM-DD (для ежедневных)"
                    },
                    "period_b": {
                        "type": "string",
                        "description": "Второй период: YYYY-MM (для месячных данных) или YYYY-MM-DD (для ежедневных)"
                    }
                },
